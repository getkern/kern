...
echo "Later, once the BTC block confirms (hours, not minutes): sh provenance/upgrade-when-ready.sh $TAG"
echo "  It is safe to run repeatedly - it commits only if the anchor actually arrived."
