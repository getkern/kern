...
**kern:** a fast, rootless container runtime and sandbox with no daemon. It runs any workload, including agent tool calls and code generated by an LLM, in real containers enforced by the kernel.
