...
**kern:** a fast, rootless container and resource runtime with no daemon. It sandboxes any workload, including agent tool calls and code generated by an LLM, in real containers enforced by the kernel.
