...
static binary (~2 MB from a source build; 1.58 MB x86_64 / 1.31 MB aarch64 in the size-optimized
...
size-optimized release build is 1.58 MB / 1.31 MB), no Rust deps beyond `libc` (the pull path shells
