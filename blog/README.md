...
|---|---|
| [Introducing kern](introducing-kern.md) | What kern is and why: a daemonless, rootless container + resource runtime in 1.59 MB, the two verbs, the embed SDK, the benchmarks, and where the security boundary actually is. |
