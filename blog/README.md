...
|---|---|
| [Introducing kern](introducing-kern.md) | What kern is and why: a daemonless, rootless container + resource runtime in one static binary, the two verbs, the embed SDK, the benchmarks, and where the security boundary actually is. |
