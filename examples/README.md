...
| [kern-mcp setup](../bindings/python/README.md#from-an-mcp-client) | Wire **`kern-mcp`** into Claude Desktop / Cursor / Windsurf: a local, **network-off** code interpreter, with every knob in one table |
